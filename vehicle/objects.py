...
class RoadObject(ABC):
    ...
    LENGTH: float = 4.14  # Object length [m]
    WIDTH: float = 1.8  # Object width [m]
    ...
    # Just added for sake of compatibility chris change
    def to_dict(self, origin_vehicle=None, observe_intentions=True,env_vehicle=None):
        ...
        d = {
            ...
            'vx': 0.,
            'vy': 0.,
            'distance_goal':self.position[0]-182.5,
            'distance_ego_vehichle':self.position[0]-env_vehicle.position[0]
        }
